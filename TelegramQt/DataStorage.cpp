...
void DataInternalApi::updateInboxRead(const Telegram::Peer peer, quint32 messageId)
{

}

void DataInternalApi::updateOutboxRead(const Telegram::Peer peer, quint32 messageId)
{
